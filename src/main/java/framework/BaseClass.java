...
import listeners.WebDriverListener;
 ...
 public class BaseClass extends ExcelData{
	...
	private static final ThreadLocal<BaseClass> baseClassObj = new ThreadLocal<BaseClass>();
	...
	public void browserSelection() throws ClassNotFoundException, SQLException {
		...
		try {
			...
			if (browserType.equals("Chrome")) {
				System.setProperty("webdriver.chrome.driver",SystemVariables.Drivers+"chromedriver.exe");
...
public void saveTestRunDetails(ITestResult result) {
		...
		List<Long> testRunInfo = new ArrayList<Long>();
